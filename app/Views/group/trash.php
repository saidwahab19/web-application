          ...
          <div class="section-body">
            ...
            <div class="card-header">
              ...
              <div class="card-header-action">
                ...
                <form action="<?=site_url('groups/delete2/')?>" method="post" class="d-inline" onsubmit="return confirm('Yakin akan dihapus?')">
                      <?= csrf_field() ?>
                      ...
                      <table class="table table-striped table-md">
                        ...
                        <tr>
                          ...
                          <td class="" style="width:25%" >
                              ...
                              <form action="<?=site_url('groups/delete2/'.$value->id_group)?>" method="post" class="d-inline" onsubmit="return confirm('Yakin akan dihapus?')">
                              <?= csrf_field() ?>
